...
impl Vector for ushort8 {
  ...
  const ZERO: Self = ushort8(0, 0, 0, 0, 0, 0, 0, 0);
  const ONE: Self = ushort8(1, 1, 1, 1, 1, 1, 1, 1);
  const TWO: Self = ushort8(2, 2, 2, 2, 2, 2, 2, 2);
  const THREE: Self = ushort8(3, 3, 3, 3, 3, 3, 3, 3);
