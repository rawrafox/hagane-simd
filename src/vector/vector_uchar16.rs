...
impl Vector for uchar16 {
  ...
  fn map_unary(self, f: &Fn(Self::Scalar) -> Self::Scalar) -> Self {
    return uchar16(f(self.0), f(self.1), f(self.2), f(self.3), f(self.4), f(self.5), f(self.6), f(self.7), f(self.8), f(self.9), f(self.10), f(self.11), f(self.12), f(self.13), f(self.14), f(self.15));
  }

  #[inline(always)]
  fn map_binary(self, other: Self, f: &Fn(Self::Scalar, Self::Scalar) -> Self::Scalar) -> Self {
    return uchar16(f(self.0, other.0), f(self.1, other.1), f(self.2, other.2), f(self.3, other.3), f(self.4, other.4), f(self.5, other.5), f(self.6, other.6), f(self.7, other.7), f(self.8, other.8), f(self.9, other.9), f(self.10, other.10), f(self.11, other.11), f(self.12, other.12), f(self.13, other.13), f(self.14, other.14), f(self.15, other.15));
  }
  ...
  fn to_char_sat(self) -> char16 {
    return uchar16::to_char(self.min(Self::broadcast(std::i8::MAX as u8)));
  }
  ...
  fn to_short_sat(self) -> short16 {
    return uchar16::to_short(self.min(Self::broadcast(std::i16::MAX as u8)));
  }
  ...
  fn to_int_sat(self) -> int16 {
    return uchar16::to_int(self.min(Self::broadcast(std::i32::MAX as u8)));
  }
  ...
  fn to_long_sat(self) -> long16 {
    return uchar16::to_long(self.min(Self::broadcast(std::i64::MAX as u8)));
  }
