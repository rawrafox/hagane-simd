...
impl Vector for ushort3 {
  ...
  fn map_unary(self, f: &Fn(Self::Scalar) -> Self::Scalar) -> Self {
    return ushort3(f(self.0), f(self.1), f(self.2));
  }

  #[inline(always)]
  fn map_binary(self, other: Self, f: &Fn(Self::Scalar, Self::Scalar) -> Self::Scalar) -> Self {
    return ushort3(f(self.0, other.0), f(self.1, other.1), f(self.2, other.2));
  }
  ...
  fn to_char_sat(self) -> char3 {
    return ushort3::to_char(self.min(Self::broadcast(std::i8::MAX as u16)));
  }

  #[inline(always)]
  fn to_uchar_sat(self) -> uchar3 {
    return ushort3::to_uchar(self.min(Self::broadcast(std::u8::MAX as u16)));
  }

  #[inline(always)]
  fn to_short_sat(self) -> short3 {
    return ushort3::to_short(self.min(Self::broadcast(std::i16::MAX as u16)));
  }
  ...
  fn to_int_sat(self) -> int3 {
    return ushort3::to_int(self.min(Self::broadcast(std::i32::MAX as u16)));
  }
  ...
  fn to_long_sat(self) -> long3 {
    return ushort3::to_long(self.min(Self::broadcast(std::i64::MAX as u16)));
  }
