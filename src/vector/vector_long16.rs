...
impl Vector for long16 {
  ...
  fn to_char_sat(self) -> char16 {
    return long16::to_char(clamp(self, broadcast(std::i8::MIN as i64), broadcast(std::i8::MAX as i64)));
  }

  #[inline(always)]
  fn to_uchar_sat(self) -> uchar16 {
    return long16::to_uchar(clamp(self, broadcast(std::u8::MIN as i64), broadcast(std::u8::MAX as i64)));
  }

  #[inline(always)]
  fn to_short_sat(self) -> short16 {
    return long16::to_short(clamp(self, broadcast(std::i16::MIN as i64), broadcast(std::i16::MAX as i64)));
  }

  #[inline(always)]
  fn to_ushort_sat(self) -> ushort16 {
    return long16::to_ushort(clamp(self, broadcast(std::u16::MIN as i64), broadcast(std::u16::MAX as i64)));
  }

  #[inline(always)]
  fn to_int_sat(self) -> int16 {
    return long16::to_int(clamp(self, broadcast(std::i32::MIN as i64), broadcast(std::i32::MAX as i64)));
  }

  #[inline(always)]
  fn to_uint_sat(self) -> uint16 {
    return long16::to_uint(clamp(self, broadcast(std::u32::MIN as i64), broadcast(std::u32::MAX as i64)));
  }
