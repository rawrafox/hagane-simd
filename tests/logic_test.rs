...
fn any() {
  ...
  assert_eq!(uchar2::any(uchar2(0x80, 0x00)), true);
  assert_eq!(uchar2::any(uchar2(0x7F, 0x7F)), false);
  assert_eq!(uchar2::any(uchar2(0x7F, 0xFF)), true);
  assert_eq!(uchar2::any(uchar2(0x10, 0x40)), false);
  assert_eq!(uchar3::any(uchar3(0x80, 0x00, 0x80)), true);
  assert_eq!(uchar3::any(uchar3(0x00, 0x00, 0x00)), false);
  assert_eq!(uchar3::any(uchar3(0x00, 0x00, 0x00)), false);
  assert_eq!(uchar4::any(uchar4(0x80, 0x00, 0x80, 0x80)), true);
  assert_eq!(uchar4::any(uchar4(0x00, 0x00, 0x00, 0x00)), false);
  assert_eq!(uchar4::any(uchar4(0x00, 0x00, 0x00, 0x00)), false);
...
fn all() {
  ...
  assert_eq!(uchar2::all(uchar2(0x80, 0x00)), false);
  assert_eq!(uchar2::all(uchar2(0x80, 0x80)), true);
  assert_eq!(uchar3::all(uchar3(0x80, 0x00, 0x80)), false);
  assert_eq!(uchar3::all(uchar3(0x80, 0x80, 0x80)), true);
  assert_eq!(uchar4::all(uchar4(0x80, 0x00, 0x80, 0x80)), false);
  assert_eq!(uchar4::all(uchar4(0x80, 0x80, 0x80, 0x80)), true);
